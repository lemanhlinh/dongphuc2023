<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            <label>@lang('form.slider.name')</label> <span class="text-danger">*</span>
            <input type="text" class="form-control" name="name" value="{{ isset($slider) ? $slider->name : old('name') }}" required>
            @if ($errors->has('name'))
